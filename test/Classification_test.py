...
def model_evaluation(model, batch_size):
    ...
    for cellid in test_cell_idx:
        ...
        for batch_start, batch_end in batch_indices:
            ...
            X_test_gexp = np.zeros((batch_end - batch_start, NUM_TF))
...
if  __name__ == "__main__" :
    ...
    label_file='%s/data/union.peaks.labels.class.txt'%DPATH
    ...
    region_idx.sort()
    model = torch.load('%s/data/checkpoint/model.pth' % (DPATH))
    print('Start testing...')
